...
adc.readChannel(ADS1x15.channel.CHANNEL_0, (err, value, volts) => {
    ...
    if (err) {
        ...
        console.log(value);
        console.log('The moisture in the soil is :', Math.round(moisture,2), '%');    // will be a 11 or 15 bit integer depending on chip
